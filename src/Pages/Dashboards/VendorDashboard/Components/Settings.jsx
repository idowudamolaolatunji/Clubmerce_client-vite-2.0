  ...
  return (
		<DashboardUi>
			...
			<form className="delete-data">
				...
				<span>
                    Every info about this vendor account, transactions, products, purchases, orders and order histories, personal details and other sensitive informations would be removed as you click <strong style={{ color: "#f15a29" }}>Delete My Account!</strong>
				</span>
