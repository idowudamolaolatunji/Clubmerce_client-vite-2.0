...
function VerifiedModal() {
  ...
  <div className="email-confirmed__modal modal">
    <div className="modal__container">
      <h3 className="extra__heading">Success!</h3>
      <svg
