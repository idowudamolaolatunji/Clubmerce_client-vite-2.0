		...
		<header className={`header ${show ? 'sticky' : ''}`}>
			...
			<nav className="navar">
				...
				<ul className="nav__list">
					...
					<li className="nav__item">
						<NavLink className={`nav__link ${location.pathname === '/affiliate-resourses' ? 'nav__active' : ''}`} to="-resourses">
							Affiliate
						</NavLink>
					</li>
					<li className="nav__item">
					...
					<li className="nav__item">
                        ...
                        : 
                            <NavLink className={`nav__link nav__button nav-sign nav__button--active`} to={`${user.role === 'affiliate' ? '/affiliates/dashboard' : user.role === 'vendor' ? '/vendors/dashboard' : '/'}`}> 
                                Dashboard
                            </NavLink>
                        }
					</li>
